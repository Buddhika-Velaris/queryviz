        ...
        <div className="max-w-7xl xl:max-w-screen-xl 2xl:max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            ...
            <Link to="/" className="flex items-center gap-2.5 group">
              ...
              <span className="text-base font-bold text-white tracking-tight">QueryViz</span>
              <span className="hidden sm:inline text-xs text-gray-500 font-medium pl-1 border-l border-gray-700">
                PostgreSQL Analyzer
              </span>
            </Link>
            ...
            <div className="flex items-center gap-1">
              ...
              <a
                href="https://github.com/Buddhika-Velaris/queryviz"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium text-gray-400 hover:text-gray-100 hover:bg-gray-800 transition-colors"
              >
